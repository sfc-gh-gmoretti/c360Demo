...
const steps = [
  { id: 1, name: "Branding", path: "/setup/branding" },
  { id: 2, name: "Snowflake", path: "/setup/snowflake" },
  { id: 3, name: "Sample Data", path: "/setup/data" },
  { id: 4, name: "Deploy", path: "/setup/deploy" },
  { id: 5, name: "Test", path: "/setup/test" },
];
